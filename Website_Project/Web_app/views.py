...
def booking(request):
    if request.method=='POST':
        ...
        if form.is_valid():
            form.save()
        messages.success(request,('Your Appointment has been booked successfully , we will contact you shortly'))
        return render(request,'home.html',{})
...
def send_otp(number,message):
    ...
    api = "e6AyTXOHchUwdnE3jGuJ279NK5lioqrtxMQZkR1PBa8FYSVImpWiCJ8OdoHbNQZyjFn4hVlf1qzwDgeB"
